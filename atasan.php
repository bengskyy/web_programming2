	<nav class="navigation-bar dark">
        <nav class="navigation-bar-content container">
			...
			<ul class="element-menu">
				...
				<a class="element place-right" href="http://facebook.com/Mr.krab69">
				...
				<a class="element place-right" href="https://twitter.com/">
				...
				<a class="element place-right" href="https://instagram.com/d_poetraa">
