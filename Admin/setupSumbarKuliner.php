...
if(isset($_SESSION['user_admin'])){
	...
	{
		mysql_query("INSERT INTO setup_Jatim (kat_Jatim, judul_Jatim, konten_Jatim)
	...
	{
		mysql_query("UPDATE setup_Jatim SET kat_Jatim='kuliner', judul_Jatim='$judul', konten_Jatim='$_POST[konten]' WHERE id_Jatim= '$_POST[id]'");
	
	}
	
	else if(isset($_POST['Delete']))
	{
		mysql_query("DELETE FROM setup_Jatim WHERE id_Jatim = '$_POST[id]'");
                    ...
                    <div class="panel-body">
                        <div class="row col-lg-10">
							...
							<?php
								if (isset($_GET['id']))
								{
								$comot_id=mysql_query("select * from setup_Jatim where id_Jatim=".$_GET['id']);   
                    ...
                    <div class="panel-body">
                        <div class="row col-lg-10">
                        	<table class="table table-hover table-striped">
                                ...
                                <?php
									$no=1;
									$comot=mysql_query("select * from setup_Jatim where kat_Jatim='kuliner' order by id_Jatim");
