...
if(isset($_SESSION['user_admin'])){
	...
	{
		mysql_query("UPDATE setup_Jatim SET kat_Jatim='profil', judul_Jatim='$judul', konten_Jatim='$_POST[konten]' WHERE id_Jatim= '$_POST[id]'");
                    ...
                    <div class="panel-body">
                        <div class="row col-lg-10">
                        	<table class="table table-hover table-striped">
                                ...
                                <?php
									$no=1;
									$comot=mysql_query("select * from setup_Jatim where kat_Jatim='profil' order by id_Jatim");
